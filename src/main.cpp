...
void mostrarAjuda(const char *programa)
{
    ...
    std::cout << "Controles:\n";
    std::cout << "  Layout principal (otimizado para jogos):\n";
    std::cout << "  8  (Cima)      -> W\n";
    std::cout << "  2  (Baixo)     -> S\n";
    std::cout << "  4  (Esquerda)  -> A\n";
    std::cout << "  6  (Direita)   -> D\n";
    std::cout << "  5  (Ação/Tiro) -> Espaço\n\n";

    std::cout << "  Teclas alternativas (inspiradas no layout original do Chip-8):\n";
    ...
    std::cout << "Exemplo prático (Pong):\n";
    std::cout << "  Barra Esquerda -> 1 (Cima), A (Baixo)\n";
    std::cout << "  Barra Direita  -> 4 (Cima), R (Baixo)\n";
}
